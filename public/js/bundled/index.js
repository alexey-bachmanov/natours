...
})({"8ftZV":[function(require,module,exports) {
...
if (bookBtn) // you're on the tour details page and logged in
bookBtn.addEventListener("click", (e)=>{
    // change button text
    bookBtn.textContent = "Processing...";
    // pull tourId from checkout button and book that tour
    (0, _stripe.bookTour)(bookBtn.dataset.tourId);
});

},{"./login":"7yHem","./leaflet":"xvuTT","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports) {
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51NgvWQDFESPntBMNAicNmxYcIvFsMtxS0o8raPPWT6I4wmLg2fZgbPhG3TgKvwSosMDcs8GGDCrx1HfGJtBu9FvV00gnqJTYol");
const bookTour = async (tourId)=>{
    try {
        // get checkout session from api endpoint
        // /api/v1/bookings/checkout-session/[tourId]
        const response = await (0, _axiosDefault.default)(`/api/v1/bookings/checkout-session/${tourId}`);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}]},["8ftZV","f2QDv"], "f2QDv", "parcelRequire11c7")
